...
const Main = () => {
  ...
  <div className="lay-2">
    ...
    <div className='nav2'>
      ...
      <div className="nav2-1">
                     <div onClick={() =>router.push('/main')} className='svg'>{icon.home}</div>
                     <div onClick={() =>router.push('/search')} className='svg'>{icon.search}</div> 
  ...
  <div className="add-post h-[70px] flex items-center justify-end border border-stone-800 text-zinc-500">
    <div className='current'>
      <img className='cpro' src={currentUser?.profilepic || "https://pbs.twimg.com/profile_images/1622382458162520064/d7kv4B_c_400x400.jpg"} alt="profilepic" />  
    ...
    posts.map((post) => (
      <div key={post._id} className="f-layout">
        <div className="p-1">
          <img
            className='f-propic'
            src={post.postById?.profilePic || "https://pbs.twimg.com/profile_images/1622382458162520064/d7kv4B_c_400x400.jpg"}
            alt="profile"
          />
        </div>
        <div className="p-2">
